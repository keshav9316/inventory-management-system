   ...
   <script src="js/logout.js"></script>
            ...
            <button class="space3" onClick="logout()">LOGOUT</button>
	       	...
	       	<div class="search" style="padding-left: 2%; padding-top: .5%; padding-right: 2%;">
					<CENTER><div id="" class="active1 search"> APPLICATION SUCCESSFULLY SUBMITED</div>
					</CENTER>
			</div>
   	...
   	<div class="content-wrap"> 
		   <div class="main-content">
            ...
            <table>
              ...
              <div class="align"><tr><td><img src="images/slides/9.png" style="height: 43%; width: 355px;"></td></tr></div>
            </table>
                     <br>
