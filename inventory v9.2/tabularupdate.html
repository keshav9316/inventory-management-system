...
<!DOCTYPE html>
<html id="tabularupdate" class="no-js" lang="en">
<head>
...
<body>
  ...
  <div class="active2">
            ...
            <button class="space3" onClick="logout()">LOGOUT</button>
	       	...
	       	<div class="search" style="padding-left: 4.6%; padding-top: 0.5%; padding-right: 4.5%;">
...
<table width="1226" align="center" style="border-width: 2px;">
  <tr>
    ...
    <td width="234"class="active" ><center>UPDATE</center></td>
      ...
      <!--selection  -->
<?php
require 'php/select_tabularview.php'; 
...
if($status!="CLOSED"){
echo "<td><center><form action='updateout.php' method='post'><input type='hidden' name='appno_inp' value=$appno require><input type='submit' value='UPDATE'></form></center></td> </tr>";
}
