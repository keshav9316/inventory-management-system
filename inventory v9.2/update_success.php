...
<body>
  ...
  <div class="active2">
            ...
            <button class="space3" onClick="logout()">LOGOUT</button>
	       	...
	       	<div class="search" style="padding-left: 2%; padding-top: 0.5%; padding-right: 2%;">
					<CENTER><div id="" class="active1 search"> APPLICATION NO.<?php echo $appno; ?> SUCCESSFULLY UPDATED</div>
					</CENTER>
			</div>
   	...
   	<div class="content-wrap"> 
		   <div class="main-content">
            ...
            <table>
              <div class="align"><tr><td><label> 
                  <!-- YOUR APPLICATION HAS BEEN SUCCESSFULLY UPDATED  -->
               </label></td></tr></div>
              <div class="align"><tr><td><img src="images/slides/9.png" style="height: 50%; width: 350px;"></td></tr></div>
            </table>

            <!-- <form action="viewout.php" method="POST">
                   <input type="submit" value="VIEW UPDATED APPLICATION">           
                   </form> -->
