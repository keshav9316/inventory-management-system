         ...
         <script src="js/logout.js"></script>
            ...
            <button class="space3" onClick="logout()">LOGOUT</button>
	       	...
	       	<div class="search" style="padding-left: 0.1%; padding-top: .5%; padding-right: 0.1%;">
					<CENTER><div id="" class="active1">FILL DETAILS OF INVENTORY GRANTED TO LASTEC LAB, DRDO</div>
					</CENTER>
			</div>
		   		...
		   		<div class="col-twelve">
					...
					<center>
			  		  <div id="inventoryform1" class="search">	
							  <form action="php/insert_amc.php" method="POST">
                          <div class="align"><label>ITEM NAME : </label>
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input type="text" name="item_name" required></div>

                          <div class="align"><label>ITEM TYPE : </label>
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <select type="text" name="type" class="active2" required>
                          ...
                          <div class="align"><label>MODEL NO. / SERIAL NO. : </label>
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input type="text" name="model_no" required></div>
                          
                          <div class="align"><label>NUMBER OF ITEMS GRANTED : </label>
                       
                          <input type="text" name="total_device" required></div>
<br>
    ...
    <!-- footer -->
      ...
      <div class="active2">
       <hr>
       <h3>
                  <center><p id="footer">Developed and Maintained by IT & IS GROUP,  LASTEC
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <date id="date"></date>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <time class="red" id="time"></time>
                  </p></center>
                  <script src="js/date.js"></script></h3>
       <hr>
     </div>
